...
const inViewport = (entries, observer) => {
  ...
  const obsOptions = {threshold: 0,rootMargin:'500px'}; //See: https://developer.mozilla.org/en-US/docs/Web/API/Intersection_Observer_API#Intersection_observer_options
